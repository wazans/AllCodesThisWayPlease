...
class Class2_topicThrowUnchecked_CommandLine {
	...
	public static void main(String[] args) {
		...
		/*
		 * Command line arguments are ALWAYS String So we must convert String → int
		 */
		int age = Integer.parseInt(args[0]);

		/*
		 * Business rule: Voting allowed only for age >= 18
		 */
		if (age < 18) {

			/*
			 * throw keyword: - Manually creates and throws an exception - RuntimeException
			 * is UNCHECKED - JVM does not force try-catch
			 */
