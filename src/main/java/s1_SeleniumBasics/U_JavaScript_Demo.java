...
public class U_JavaScript_Demo {
	...
	public static void sendKeys_usingJSE() {
		...
		/*
		 * Type Casting: The (JavascriptExecutor) part is a type cast, which converts
		 * the driver object to the JavascriptExecutor type.
		 */

		/*
		 * Purpose: This allows the use of the executeScript and executeAsyncScript
