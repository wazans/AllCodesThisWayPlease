...
public class E_DefaultCalenderDate {
	...
	public static void Cal_auto_date() throws InterruptedException {
		...
		Thread.sleep(5000);
		// a[@value='MAA'] --- this will try to select the 'chennai' from the source and
		// will fail so rather use next line
		// driver.findElement(By.xpath("(//a[@value='MAA'])[2]")).click();
		// or to avoid indexing use parent-xpath//child-xpath
		//// div[@id='ctl00_mainContent_ddl_destinationStation1_CTNR'] selects the
		// complete destination window
