...
public class U_StringComparisonExample {
	public static void main(String[] args) {
		...
		/*
		 * 
		 * String str1 = "Hello"; This creates a string "Hello" and stores it in the
		 * string pool. String str3 = "Hello"; Since "Hello" is already in the string
		 * pool, str3 refers to the same object as str1. String str2 = new
		 * String("Hello"); This creates a new string object in memory, separate from
		 * the string pool.
		 */
	}
}