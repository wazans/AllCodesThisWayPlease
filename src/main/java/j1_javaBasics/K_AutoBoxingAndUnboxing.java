...
public class K_AutoBoxingAndUnboxing {
	public static void main(String[] args) {
		...
		System.out.println(
				"The primitive variable is converted into into object reference variable num1 and this is boxing "
						+ num1);

		Integer num2 = num; // Auto-Boxing
		System.out.println(
				"The primitive variable is converted into into object reference variable num1 and this is Auto-boxing "
						+ num2);
